...
import edu.beesmart.common.exception.handling.CustomExceptionSerializer
import edu.beesmart.auth.api.IdentityService
import play.api.libs.ws.ahc.AhcWSComponents

class IdentityLoader extends LagomApplicationLoader {

  override def load(context: LagomApplicationContext): LagomApplication = new IdentityApplication(context) {
